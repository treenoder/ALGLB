class UnionFind:
    """
    Клас Union-Find (або Disjoint Set Union, DSU) для об'єднання та знаходження з представником наборів.
    ...
    def __init__(self, n):
        # Ініціалізація батьківського масиву
    ...
    def find(self, u):
        """
        Знаходить представника набору для елемента u з використанням шляху стиснення.
